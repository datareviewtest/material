...
'''
1.Start Select a level Long-click a game. 
2.The context menu pops up 
3.Select "Edit note" 
4.A dialog pops up. 
5.Cancel it.
 6.Long-click the same game. 
 7.The context menu pops up again 
 8.Select "Delete puzzle" 
 9.A confirmation dialog pops up. 
 10.Click "OK" 
 11.Rotate your phone, switch to another orientation. Crash
'''