...
def process_history(prompt, history, max_tokens, threshold):
    ...
    if tokens_in_chat_history > math.floor(max_tokens*threshold):
        ...
        print(message)
        history = load_training_prompts('/Users/dingbangwang/Desktop/GPT/Automation/prompts/training_prompts_ori.json')
...
def generate_text(prompt, history, package_name=None, model="gpt-4", max_tokens=8192, attempts = 3):
